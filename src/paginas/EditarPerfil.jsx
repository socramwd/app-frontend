...
const EditarPerfil = () => {
    ...
    const handleSubmit = async e => {
        ...
        if([nombre, email].includes('')) {
            setAlerta({
                msg: 'Email y Nombre son obligaorios',
                error: true
            })
            ...
            <div className="flex justify-center">
                <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="submit" value="Guardar Cambios" className="bg-indigo-600 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5 hover:cursor-pointer hover:bg-indigo-800"/>
                    </form>
                </div>
            </div>
        </>
